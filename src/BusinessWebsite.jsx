...
const BusinessWebsiteUI = () => {
  return (
    <div className="flex justify-center items-center h-full bg-[url('src\assets\bg.png')] bg-cover bg-center bg-no-repeat p-4">
      <div className="max-w-4xl w-screen relative">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-800">Why Your Business</h1>
          <p className="text-gray-500">Needs a Better Website</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg mb-1">Outdated Design</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg mb-1">Poor User Experience</h3>
            <p className="text-sm text-center text-gray-600">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg mb-1">Limited Functionality</h3>
            <p className="text-sm text-center text-gray-600">
        ...
        <div className="flex justify-center gap-6">
          ...
          <div className="flex flex-col items-center w-1/3">
            ...
            <h3 className="font-bold text-lg mb-1">Lack of Mobile Optimization</h3>
            <p className="text-sm text-center text-gray-600">
          ...
          <div className="flex flex-col items-center w-1/3">
            ...
            <h3 className="font-bold text-lg mb-1">Inefficient Management</h3>
            <p className="text-sm text-center text-gray-600">
